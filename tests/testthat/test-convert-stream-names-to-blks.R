test_that("fwa_convert_stream_names_to_blks works", {
  ...
  expect_identical(fwa_convert_stream_names_to_blks(c("a name", "a name2")),
                   c(576524986L, 151860402L))
  expect_identical(fwa_convert_stream_names_to_blks(c("a name3", "a name3")),
                   c(597060036L, 597060036L))
})

test_that("fwa_convert_stream_names_to_blks errors", {
  expect_error(fwa_convert_stream_names_to_blks(597060036L),
...
test_that("fwa_convert_stream_names_to_blks missing values", {
  ...
  expect_identical(fwa_convert_stream_names_to_blks(c("a name2", NA_integer_)),
