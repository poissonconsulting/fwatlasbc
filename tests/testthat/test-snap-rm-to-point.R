test_that("fwa_snap_rm_to_point works", {
  ...
  expect_equal(x$distance_to_rm, c(
    873.50885850392, 535.63765010454, 754.230245890789, 610.731097004499,
    514.952511361304
  ))
...
test_that("fwa_snap_rm_to_point handles different projection", {
  ...
  expect_equal(
    x$distance_to_rm,
    c(873.5088585027, 535.6376501050, 754.2302458901, 610.7310970031, 514.9525113550)
  )
  expect_s3_class(x$geometry, "sfc_POINT")
})
...
test_that("fwa_snap_rm_to_point handles different projection x", {
  ...
  expect_equal(
    x$distance_to_rm,
    c(870.6608791124, 534.1992001454, 754.7709791296, 609.1683438544, 513.5881458189)
  )
  expect_s3_class(x$geometry, "sfc_POINT")
})
...
test_that("fwa_snap_rm_to_point works segment", {
  ...
  expect_equal(x$distance_to_rm, c(
    2954.89069472597, 535.63765010454, 754.230245890789, 610.731097004499,
    514.952511361304
  ))
  expect_s3_class(x$geometry, "sfc_POINT")
})
...
test_that("fwa_snap_rm_to_point works segment missing value rm", {
  ...
  expect_equal(x$distance_to_rm, c(
    2331.96951067872, 535.63765010454, 754.230245890789, 610.731097004499,
    514.952511361304
  ))
  expect_s3_class(x$geometry, "sfc_POINT")
})
...
test_that("fwa_snap_rm_to_point works segment missing value x and rm", {
  ...
  expect_equal(x$distance_to_rm, c(
    873.50885850392, 535.63765010454, NA, 610.731097004499,
    514.952511361304
  ))
  expect_s3_class(x$geometry, "sfc_POINT")
})
