test_that("multiplication works", {
  ...
  expect_identical(
    streams,
    dplyr::tibble(stream_name = c("Steep Canyon Creek", "Steep Creek"))
  )
  ...
  expect_equal(
    ...
    dplyr::tibble(
      ...
      blk = c(360883036L, 356362258L, 356534225L, 356570155L)
    )
  )
  ...
  skip(
    "Columns 'blk' and 'rm' in `rms` constructed from `x` must be a unique key."
  )
