test_that("fwa_add_gm_elevation_to_point works few", {
  ...
  expect_equal(
    x$elevation,
    c(
      5, 5, 5, 5, 5, 10.393641471863, 5.355155944824, 5.000188350677,
      9.286867141724, 7.158128738403, 7.003700256348, 8.345664024353,
      10.868627548218, 10.214251518250, 11.205244064331, 11.277363777161,
      10.523103713989, 75.419944763184, 165.338165283203, 208.487548828125
    )
  )
})
