...
#' @param end A positive whole number indicating how distance (m) the end of
#' the stream has to be from the last interval to include.
#' To exclude ends set `end = gap + 1`.
